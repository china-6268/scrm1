...
public class WXBizMsgCrypt {
    ...
    public static void main(String[] args) throws AesException {
        String signature = "21bdebfe663d5ea13baab7c3c6ef4ccf96fcffbd";
        String timestamp = "1703561419";
        String nonce = "1702999777";
        String corpToken = "VnyvXEPhedUCRrkwzHzJ";
        String aesKey = "vwlnUKWMnxBiwsjYJwRKQoWWkuOnWLHopKMjivpnNgS";
        String corpId = "ww1ffc1c6c9f98b39a";
        String echostr = "OoKn/boaT41FqBTWWZJ8jIr0iayTQsvJg/ZJ6MzU7NVMcHLGFulf5rggffa2MiHsfU98oZUJCl4bB+RHrcZ3aQ==";
